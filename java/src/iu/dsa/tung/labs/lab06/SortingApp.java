package iu.dsa.tung.labs.lab06;
...
public class SortingApp {
    ...
    public static void table1() {
        int[] maxSize = {10000, 15000, 20000, 25000, 30000, 35000, 40000, 45000, 50000, 10000000};
        Array arr;

        System.out.println("Table 1 - Experiment 1: Simple sorting");
        ...
        /* -------------------------- Inverse order ------------------------*/
        Array arrSorted = new Array(maxSize[9]);
        arrSorted.randomInit(maxSize[9]);
        arrSorted.mergeSort();
        ...
        /* -------------------------- Already sorted ------------------------*/
        Array arrInverse = new Array(maxSize[9]);
        arrInverse.randomInit(maxSize[9]);
